...
public class IfElseExamples {
	public static void main(String[] args) {
		...
		else if(9 == numToBeTested) System.out.println("don't thought it's confusing");
		else {
		...
		int x = 7;
		if (x==0) if (5>numToBeTested) System.out.println("valid");
		else System.out.println("why would you do this?");//this executes as though this were a typically written nested if else statement
